// TODO(nbs): add NBS (Chen et al. 2017) variant using GMX pairs with an
//            admissible forward+backward heuristic. Would live in
//            search/bibfs_nbs.rs and share regression helpers.
