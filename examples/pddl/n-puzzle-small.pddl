; Small puzzle problem — 2 moves from solved, for quick BFS validation
; Source: modeled after eight-puzzle domain
...
(define (problem eight-puzzle-small)
    (:domain eight-puzzle)
    ...
    (:init
        ...
        ;; 1 move from goal: slide t3 down (blank moves from p9 to p3)
        (tile-at t1 p1) (tile-at t2 p2)
        (tile-at t4 p4) (tile-at t5 p5) (tile-at t3 p6)
        (tile-at t6 p9)
